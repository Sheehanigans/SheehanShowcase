...
namespace CarDealership.UI
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //given way:
            app.CreatePerOwinContext(CarDealershipDbContext.Create);
            ...
            //            new UserStore<ApplicationUser>(context.Get<CarDealershipDbContext>())));

            //app.CreatePerOwinContext<RoleManager<ApplicationRole>>((options, context) =>
            //    new RoleManager<ApplicationRole>(
            //        new RoleStore<ApplicationRole>(context.Get<CarDealershipDbContext>())));
